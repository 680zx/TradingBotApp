        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RamvQualifierToolId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Users_RamvQualifiers_RamvQualifierToolId",
                        column: x => x.RamvQualifierToolId,
                        principalTable: "RamvQualifiers",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Users_RamvQualifierToolId",
                table: "Users",
                column: "RamvQualifierToolId");
        }
